import {SELECT_BOOK,SELECT_CHANNEL,RECEIVE_POST,REQUEST_CHANNEL,ADD_BOOK,EDIT_BOOK,UPDATE_BOOK,DELETE_BOOK,RETURN_STATE} from "../actionType"; 
...
export function fetchPost(channel){
    return(dispatch)=>{
        ...
        return fetch(`https://newsapi.org/v2/top-headlines?sources=${channel}&apiKey=${MY_API_KEY}`, {
            method: 'GET'
        })
        .then((result) => {
           return result.json();
